defmodule IdkPayWeb.UserController do
  ...
  case Account.authenticate_user(user, password) do
    {:ok, user} ->
      ...
      |> render("login.html", layout: {IdkPayWeb.LayoutView, "center.html"}, changeset: changeset)        
        else
  ...
  def locked(conn, _) do
    ...
    conn
    |> Guardian.logout
    |> render("locked.html", layout: {IdkPayWeb.LayoutView, "center.html"}, name: name, avatar: avatar, username: username, changeset: changeset)
  end
